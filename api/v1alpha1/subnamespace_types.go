...
type SubnamespaceSpec struct {
	...
	// ResourceQuota for resource quota specification of this namespace
	// and every subns under it.

	ResourceQuota v1.ResourceQuota `json:"resource_quota,omitempty"`
}
...
type SubnamespaceStatus struct {
	...
	// Parent defines the subnamespace parent
